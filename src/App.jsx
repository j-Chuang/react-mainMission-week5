              ...
              <tr key={product.id}>
                ...
                <td>
                  <div className="btn-group btn-group-sm">
                    ...
                    <button disabled={isLoading} onClick={()=> addCartItem(product.id, 1)} type="button" 
          ...
          <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content">
              ...
              <div className="modal-footer">
                <button disabled={isLoading} onClick={()=> addCartItem(tempProduct.id, qtySelect)} type="button" 
